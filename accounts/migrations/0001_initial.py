    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user_type', models.CharField(choices=[('citizen', 'Citizen'), ('organization', 'Organization'), ('admin', 'Admin/Regulator')], max_length=20)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('organization_type', models.CharField(choices=[('ngo', 'NGO'), ('company', 'Company'), ('government', 'Government Agency'), ('educational', 'Educational Institution')], max_length=20)),
